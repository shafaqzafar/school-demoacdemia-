...
export default function TeacherModulePlaceholder({ title, subtitle, actions = [] }) {
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing='16px'>
        ...
        <Card p='20px'>
          ...
          <VStack align='start' spacing={2}>
            ...
            <Text fontSize='sm' color={textSecondary}>• Designed for a clean, responsive teacher workflow.</Text>
          </VStack>
        </Card>
      </SimpleGrid>
    </Box>
